...
3. Do not require summary regeneration. `summary.md` is a context artifact;
   preserve any existing operator-authored notes, but do not block checkpoint
   on shell-owned summary mutation.
...
7. Do not require summary regeneration. If the user has asked for a continuity
   note, edit the relevant `summary.md` section deliberately before committing.
