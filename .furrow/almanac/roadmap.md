...
>
> Generated via `/furrow:triage` (interactive cluster-and-approve flow during `migration-state-of-the-union` research row, 2026-04-24/25). Source: `.furrow/almanac/todos.yaml` (84 active, 47 done, 131 total). Companion machine-readable artifact: `.furrow/almanac/roadmap.yaml`.
>
